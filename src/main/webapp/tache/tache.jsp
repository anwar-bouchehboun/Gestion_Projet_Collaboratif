            ...
            tasks.forEach((task) => {
              const row = `
                <tr>
                  ...
                  <td>
                    <div class="dropdown">
                      <button class="btn btn-sm dropdown-toggle ${getPriorityClass(task.priority)}" type="button" id="priorityDropdown${task.id}" data-bs-toggle="dropdown" aria-expanded="false">
                        ${task.priority}
                      </button>
                  ...
                  <td>
                    <div class="dropdown">
                      <button class="btn btn-sm dropdown-toggle ${getStatusClass(task.status)}" type="button" id="statusDropdown${task.id}" data-bs-toggle="dropdown" aria-expanded="false">
                        ${task.status}
                      </button>
                      <ul class="dropdown-menu" aria-labelledby="statusDropdown${task.id}">
                        <li><a class="dropdown-item" href="#" onclick="updateStatus(${task.id}, 'À faire')">À faire</a></li>
                        <li><a class="dropdown-item" href="#" onclick="updateStatus(${task.id}, 'En cours')">En cours</a></li>
                        <li><a class="dropdown-item" href="#" onclick="updateStatus(${task.id}, 'Terminée')">Terminée</a></li>
                      </ul>
                    </div>
                  </td>
