  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <div class="card">
        <div class="card-header">
<<<<<<< HEAD
          <h4>Liste des TÃ¢ches</h4>
>>>>>>> 3a412fab005dd30a542ff3bd0ad148401ade0edc
=======
          <h4>Liste des Tâches</h4>
>>>>>>> 156a0e78556df07d3a607bd8c3bb1ab8cade5995
        </div>
        <div class="card-body">
          <div class="table-responsive">
            <table class="table table-striped">
...
>>>>>>> 3a412fab005dd30a542ff3bd0ad148401ade0edc
      ...
      <div class="modal-body">
        <form action="<c:url value='/tache?action=add'/>" method="post">
          ...
          <div class="mb-3">
            <label for="membreId" class="form-label">Membre assigné</label>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="<c:url value='/tache?action=edit'/>" method="post">
          ...
          <div class="mb-3">
            <label for="editMembreId" class="form-label">Membre assigné</label>
            <select
              class="form-select"
              id="editMembreId"
              name="membreId"
