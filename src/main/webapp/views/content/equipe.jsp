                  ...
                  <tr>
                    ...
                    <td class="text-center">
                      <button
                        ...
                        title="Modifier"
                        onclick="editTeam(${equipe.id}, '${equipe.nom}')"
                      >
                        <i class="bi bi-pencil"></i>
                      </button>
                      <form
                        action="${pageContext.request.contextPath}/equipe"
                        method="POST"
      ...
      <ul class="pagination justify-content-center mt-4">
        <c:forEach begin="1" end="${totalPages}" var="i">
          <li class="page-item ${currentPage == i ? 'active' : ''}">
            <a
              class="page-link"
              href="${pageContext.request.contextPath}/equipe?action=list&page=${i}"
              >${i}</a
            >
          </li>
        </c:forEach>
