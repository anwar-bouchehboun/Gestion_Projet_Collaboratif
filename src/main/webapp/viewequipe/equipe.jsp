...
<html lang="fr">
  <head>
    ...
    <title>Gestion des Equipe - Modern Design</title>
    <!-- Bootstrap 5.3.2 CSS -->
    <link
  ...
  <body>
    <div class="container">
      <h2 class="text-center mb-4">Gestion des Equipe</h2>
      <div class=" mb-0 ">
      <form action="">
        <input type="text" name="nom"  class=" py-2 ps-2	  " style="border-radius: 5px; border: none" placeholder="Enter Name Equipe">
        <button
        class="btn btn-primary"
        data-bs-toggle="modal"
        data-bs-target="#taskModal"
      >
         Créer une nouvelle Equipe
      </button>
      </form>
      </div>
      <div class="text-end mb-3">
        <button
          ...
          data-bs-target="#taskModal"
        >
          <i class="bi bi-plus-circle"></i> Créer un nouvelle Member
        </button>
      </div>
      <div class="card">
        <div class="card-header">Liste des Members</div>
